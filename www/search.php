<?php
    ...
    print "<form action=\"/page/$page\" method=\"post\">\n";
    ...
    print " <div id=\"Profil_card\" class=\"w3-card-4 w3-margin =\"> ";
        ...
        print "<div id=\"friends_container_menu\" class=\"w3-container\"> ";
            ...
            print " </div> ";
            print "<div class=\"w3-container w3-left-align\"> ";
                print "<a href=\"/page/friends_invit\"><button id=\"card_friends_buttons_invit\" class=\"w3-btn w3-round-xxlarge w3-hover-light-gray w3-blue-gray\">Invitations</button></a>";
                print "<a href=\"/page/friends_list\"><button id=\"card_friends_buttons_yourfriends\" class=\"w3-btn w3-round-xxlarge w3-hover-light-gray w3-blue-gray\">Vos amis</button></a>";
            print " </div> ";
        print " </div> ";
           ...
           // Affichages des cards
            foreach ($rs as $row)
            {
                ...
                print "<div class=\"card_friends\">";
                    print "<div class=\"image_cards_friends\">";
                        //affichage avatar
                            ...
                            print "<div class=\"card_friends_buttons\">";
                                ...
                                if (!$friend_id)
                                {
                                    print "<button type=\"submit\" name=\"btnaddfriend\" value=\"$user_id\""
                                      ." id=\"card_friends_buttons_add\" class=\"w3-button w3-round w3-hover-pale-red w3-pink\">Ajouter en ami</button>";
                                }
                                if ($friend_id)
                                {
                                    print "<button type=\"submit\" name=\"btndeletefriend\" value=\"$user_id\""
                                      ." class=\"w3-button w3-round w3-hover-light-gray w3-blue-gray\">Supprimer des amis</button>";
                                }
                            print "</div>";
                        }
                    print "</div>";
